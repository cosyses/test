...
Example: ${scriptName} --applicationName Elasticsearch --applicationVersion 5.6 --bindAddress 0.0.0.0 --port 9200
EOF
}
...
echo "Installing Elasticsearch 5.6.16"
install-package elasticsearch 5.6.16
