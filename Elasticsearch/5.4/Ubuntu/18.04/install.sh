...
Example: ${scriptName} --applicationName Elasticsearch --applicationVersion 5.4 --bindAddress 0.0.0.0 --port 9200
EOF
}
...
add-repository "elastic-5.x.list" "https://artifacts.elastic.co/packages/5.x/apt" "stable" "main" "https://artifacts.elastic.co/GPG-KEY-elasticsearch" "n"

echo "Installing Elasticsearch 5.4.3"
install-package elasticsearch 5.4.3
...
mkdir -p /opt/install/
crudini --set /opt/install/env.properties elasticsearch version "5.4"
